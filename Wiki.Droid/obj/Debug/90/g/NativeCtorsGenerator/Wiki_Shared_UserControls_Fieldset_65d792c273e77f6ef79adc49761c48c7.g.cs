...
namespace Wiki.Shared.UserControls
{
	...
	partial class Fieldset
	{
		...
		/// </remarks>
		public Fieldset(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public Fieldset(IntPtr handle) : base (handle) { }
#endif
	}
}
