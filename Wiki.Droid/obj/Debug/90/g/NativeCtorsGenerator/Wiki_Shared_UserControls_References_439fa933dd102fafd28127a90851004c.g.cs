...
namespace Wiki.Shared.UserControls
{
	...
	partial class References
	{
		...
		/// </remarks>
		public References(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public References(IntPtr handle) : base (handle) { }
#endif
	}
}
